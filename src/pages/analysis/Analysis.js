...
class Analysis extends Component {
    ...
    // 获取定时器的ID，调用loaddata()，并且每次loaddata()的参数都不一样。修改了状态，没有返回值
    ...
    //
    onClickBtn3() {
        this.store.getRealTimeData()    //*这一行的作用是什么?
        this.setState({
            ...this.state,
            dataType: 'realtime',
    ...
    pointbtn3 = () => {
        ...
        // X轴刻度线数组
        let timeStrList = ['2020/1/1', '2020/1/8', '2020/1/15', '2020/1/22',
        '2020/1/29', '2020/2/5', '2020/2/12', '2020/2/19', '2020/2/26', '2020/3/4', '2020/3/11', '2020/3/18', '2020/3/25', '2020/4/1', '2020/4/8', '2020/4/15', '2020/4/22', '2020/4/29', '2020/5/6', '2020/5/13', '2020/5/20', '2020/5/27', '2020/6/3', '2020/6/10', '2020/6/17', '2020/6/24',
        '2020/7/1', '2020/7/8', '2020/7/15', '2020/7/22', '2020/7/29']
        this.setState({
            ...this.state,
