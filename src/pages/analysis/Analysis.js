...
class Analysis extends Component {
    ...
    // 加载测试数据
    onClickBtn1() {
        let hourData = [38, 40, 46, 46, 38, 55, 36, 30, 22, 26, 38, 34, 74, 47, 15, 31, 47, 32, 23, 28, 64, 28, 38, 46]
    ...
    onClickBtn8 = () => {
        ...
        // 三元桥工作日
        let testData1 = [42, 47, 48, 46, 47, 34, 45, 30, 43, 48, 44, 49, 40, 46, 41, 38, 41, 43, 48, 47, 34, 47, 47, 41, 34, 46, 47, 37, 46, 49, 48, 42, 43, 62, 48, 41, 49, 48, 43, 42, 35, 49, 32, 36, 40, 46, 45, 49, 47, 44, 31, 49, 53, 48, 48, 44, 60, 54, 50, 43, 43, 43, 42, 58, 36, 50, 47, 54, 39, 43, 76, 57, 48, 33, 40, 47, 70, 51, 47, 51, 43, 41, 45, 30, 35, 40, 51, 36, 64, 65, 39, 39, 66, 43, 45, 62, 65, 39, 63, 66, 44, 34, 47, 56, 55, 40, 45, 53, 34, 51, 42, 41, 34, 32, 52, 35, 36, 92, 51, 55, 61, 55, 37, 46, 37, 60, 45, 34, 47, 51, 52, 32, 38, 57, 60, 54, 59, 49, 47, 60, 44, 41, 53, 68, 52, 76, 36, 68, 60, 60, 61, 71, 52, 55, 37, 37, 52, 55, 41, 45, 73, 37, 43, 43, 65, 59, 58, 75, 74, 62,
    ...
    pointbtn3 = () => {
        // 三元桥长周期早高峰平均
        let lineData = [28, 23, 24, 42, 41, 35, 38, 42, 36, 33, 28, 28, 27, 30, 30, 25, 24, 36, 20, 25, 28, 25, 26, 24, 24, 32, 31, 26, 26, 25, 27]

        // 西直门长周期
        lineData = [30, 18, 12, 49, 55, 44, 38, 45, 39, 38, 29, 25, 27, 29, 29, 21, 14, 39, 14, 20, 21, 21, 19, 24, 37, 52, 29, 23, 21, 23, 22]
        // X轴刻度线数组
        let timeStrList = ['2020/1/1', '2020/1/8', '2020/1/15', '2020/1/22', '2020/1/29', '2020/2/5', '2020/2/12', '2020/2/19', '2020/2/26', '2020/3/4', '2020/3/11', '2020/3/18', '2020/3/25', '2020/4/1', '2020/4/8', '2020/4/15', '2020/4/22', '2020/4/29', '2020/5/6', '2020/5/13', '2020/5/20', '2020/5/27', '2020/6/3', '2020/6/10', '2020/6/17', '2020/6/24', '2020/7/1', '2020/7/8', '2020/7/15', '2020/7/22', '2020/7/29']
        this.setState({
            ...this.state,
